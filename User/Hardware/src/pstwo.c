...
void PS2_Init(void)
{
    ...
    LL_GPIO_Init(GPIOC, &GPIO_InitStructure);                                       //根据设定参数初始化GPIO

    GPIO_InitStructure.Pin = LL_GPIO_PIN_1 | LL_GPIO_PIN_3; //端口配置
    GPIO_InitStructure.Mode = LL_GPIO_MODE_OUTPUT_10MHz;       //推挽输出
    GPIO_InitStructure.Speed = LL_GPIO_SPEED_FREQ_MEDIUM;      // 50M
    GPIO_InitStructure.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
    LL_GPIO_Init(GPIOC, &GPIO_InitStructure);                 //根据设定参数初始化GPIOA

    GPIO_InitStructure.Pin = LL_GPIO_PIN_4;         //端口配置
    GPIO_InitStructure.Mode = LL_GPIO_MODE_OUTPUT_10MHz;  //推挽输出
    GPIO_InitStructure.Speed = LL_GPIO_SPEED_FREQ_MEDIUM; // 50M
    GPIO_InitStructure.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
    LL_GPIO_Init(GPIOA, &GPIO_InitStructure);            //根据设定参数初始化GPIOB
}
