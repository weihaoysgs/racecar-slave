...
#define DI_GPIO_PIN		    GPIO_Pin_2			        /* DI的端口 */

#define DO_GPIO_CLK 	    RCC_APB2Periph_GPIOC		/* DO端口时钟*/
#define DO_GPIO_PORT    	GPIOC		                /* DO端口 */
#define DO_GPIO_PIN		    GPIO_Pin_1			        /* DO的端口 */

#define CS_GPIO_CLK 	    RCC_APB2Periph_GPIOC		/* CS端口时钟*/
#define CS_GPIO_PORT    	GPIOC		                /* CS端口 */
#define CS_GPIO_PIN		    GPIO_Pin_3			        /* CS的端口 */

#define CLK_GPIO_CLK 	    RCC_APB2Periph_GPIOA		/* CLK端口时钟*/
#define CLK_GPIO_PORT    	GPIOA		                /* CLK端口 */
#define CLK_GPIO_PIN	    GPIO_Pin_4			        /* CLK的端口 */
