...
// IO 口对应的引脚控制
#define OLED_RST_Clr() GPIO_ResetBits(GPIOC, GPIO_Pin_15)
#define OLED_RST_Set() GPIO_SetBits(GPIOC, GPIO_Pin_15)

#define OLED_RS_Clr() GPIO_ResetBits(GPIOC, GPIO_Pin_0)
#define OLED_RS_Set() GPIO_SetBits(GPIOC, GPIO_Pin_0)

#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOC, GPIO_Pin_13)
#define OLED_SCLK_Set() GPIO_SetBits(GPIOC, GPIO_Pin_13)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOC, GPIO_Pin_14)
